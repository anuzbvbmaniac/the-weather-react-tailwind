...
const Hourly = ({ weather }) => {
    ...
    const currentReading = weather.degreeType === 'celsius' ? celsiusReading : fahrenheitReading;
        ...
        <div className="max-w-8xl mx-auto lg:px-10 md:px-8 px-4">
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <div className="flex flex-col justify-center text-black dark:text-gray-200">
                    ...
                    <p className="text-3xl font-semibold pt-2 capitalize">{weather.currentData.weather[0].description}</p>
                    <p className="text-2xl font-medium pt-2">{`${weather.location.city}, ${weather.location.countryName}`} Weather</p>
                </div>

                <div className="flex flex-col justify-center items-center">
                    <img src={`${process.env.PUBLIC_URL}/assets/img/icons/11d.png`} alt="" className="mx-auto w-5/6"/>
                </div>
                            ...
                            <li className={'py-1 border-b-2 border-gray-300'} key={index}>
                                <div className="flex items-center">
                                    <div className="flex-shrink-0">
                                        <img className="h-8 w-8 rounded-full" src={items.icon} alt=""/>
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-semibold text-gray-900 truncate dark:text-gray-200">{items.title}</p>
                                    </div>
                                    <div>
